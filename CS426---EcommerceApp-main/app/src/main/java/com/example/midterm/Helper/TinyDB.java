...
public class TinyDB {
    ...
    public ArrayList<AllProduct> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<AllProduct> playerList =  new ArrayList<AllProduct>();

        for(String jObjString : objStrings){
            AllProduct player  = gson.fromJson(jObjString,  AllProduct.class);
    ...
    public void putListObject(String key, ArrayList<AllProduct> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(AllProduct player: playerList){
